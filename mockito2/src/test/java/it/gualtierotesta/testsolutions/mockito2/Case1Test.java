...
public class Case1Test {
    ...
    public void testNoUsers() {
        ...
        // then
        assertThat(res).isEqualTo("No users logged");
    }
    ...
    public void testOneUser() throws Exception {
        ...
        String res = sut.loggerUsersMessage();
        // then
        assertThat(res).isEqualTo("1 logged user");
    }
    ...
    public void testNUsers() throws Exception {
        ...
        String res = sut.loggerUsersMessage();
        // then
        assertThat(res).endsWith("logged users").startsWith(String.valueOf(num));
    }
    ...
    public void testRaisedException() throws Exception {
        ...
        String res = sut.loggerUsersMessage();
        // then
        assertThat(res).contains("No users");
    }
